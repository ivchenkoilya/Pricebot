...
START_TEXT = (
    ...
    '━━━━━━━━━━━━━━━━━━\n'
    '🧪 <b>Clarify всё ещё находится в разработке</b>\n\n'
    'Мы только начинаем и улучшаем Clarify вместе с пользователями. '
    'Если что-то работает медленно, неправильно или вам не хватает какой-то функции — напишите в <code>/support</code>.\n\n'
    'Ваши отзывы напрямую помогают нам находить проблемы, исправлять ошибки и выпускать следующие обновления быстрее. 💙'
)
